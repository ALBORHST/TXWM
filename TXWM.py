...
██║ ╚═╝ ██║██║  ██║██║  ██║╚███╔███╔╝██║  ██║██║ ╚████║    ██║  ██║██║███████║██║  ██║██║  ██║██║ ╚═╝ ██║
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝  ╚═══╝    ╚═╝  ╚═╝╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝
                                                                                    \033[43m\033[1;91m        [ Marwan Hisham]      
\033[43m\033[1;91m[WhatsApp : 0915995366
\033[43m\033[1;91m[Facebook : Marwan(⓲) ➊ Hisham
<=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=>
"""
...
def encryptsh():
    in_file = input(yellow+"\n▶▶▶"+white+" ﻩﺮﻔﺸﺗ ﻲﺒﺗ ﻲﻠﻳ ﻒﻠﻣ ﻢﺳﺍ  > "+cyan)
...
def encryptem():
    ...
    if not os.path.isfile(in_file):
            ...
            os.system("sleep 2")
            encryptem()
    out_file= input(yellow+"▶▶▶ "+white+"ﻩﺮﻔﺸﺗ ﻲﺒﺗ ﻲﻠﻳ ﻒﻠﻣ ﻲﻟ ﻢﺳﺍ ﺮﻳﺩ > " + green)
...
def main():
    os.system("clear")
    slowprint(logo)
    print(yellow+'╔═════════════['+white+' Marwan Hisham'+yellow+' ]═════▶▶▶')  
    print(yellow+'║'+green+' ['+white+'1'+green+']'+yellow+'  ﺮﻴﻔﺸﺗ'+cyan+'  ﻲﺟﻮﻤﻳﺍ')
   # print(yellow+'║'+green+' ['+white+'7'+green+']'+yellow+' About')
    print(yellow+'║'+green+' ['+white+'0'+green+']'+yellow+'  ﺝﻭﺮﺧ')
    print(yellow+'║')
    print(yellow+'║')
